...
/**
 * 特定在留カード等(特定在留カード・特定特別永住者証明書)の読み取り画面です。
 * <p>データ構造は第2世代在留カード等と共通なので、ビューアは
 * {@link ViewerFragment#ASSET_RC2}を共用します({@link RCSReaderTask}参照)。
 */
public class RCSReaderActivity
    extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rcs_reader);
        this.enableNFC = true;
    ...
    public void onTagDiscovered(final Tag tag) {
        ...
        runOnUiThread(() -> {
            ...
            hideKeyboard();
            RCSReaderTask task = new RCSReaderTask(this, tag, rcNum);
            exec.submit(task);
        });
    }
